quest_list = {
    0: ['Какая страна первой запустила спутник?', 'СССР'],
    1: ['Кто является первой женщиной-космонавтом?', 'Валентина Терешкова'],
    2: ['Как назывался корабль, на котором 12 апреля 1961 года Юрий Гагарин совершил первый полёт в космос?', 'Восток'],
